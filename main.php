...
<section id="hero2" class="d-flex align-items-center">
    <div class="container">
        <h1>Vision Center</h1>
        <h2>Together we see the future</h2>
    </div>
</section><!-- End Hero -->
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="content">
                        ...
                        <p>
                            Vision Center is dedicated to improving the quality of our patients' vision and their lives.
                ...
                <div class="col-lg-4">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Location:</h4>
                            <p>
                                Vision Center, Komune e Parisit, Tiranë
                            </p>
                        </div>
                        ...
                        <div class="email">
                            ...
                            <h4>Email:</h4>
                            <p>contact@visioncenter.al</p>
                        </div>

                        <div class="phone">
                            <i class="bi bi-phone"></i>
                            <h4>Call:</h4>
                            <p>+355 60 69 69 420</p>
                        </div>
...
<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p>
                        Vision Center, <br>
                        Komuna e Parisit, Tirane<br><br>
                        <strong>Phone:</strong> +355 60 69 69 420<br>
                        <strong>Email:</strong> contact@visioncenter.al <br>
                    </p>
                </div>
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="me-md-auto text-center text-md-start">
            <div class="copyright">
                &copy; Copyright <strong><span>Vision Center</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
                Designed by <a href="https://github.com/reiashimi/eye-clinic-soft-eng">VisionCenter</a>
            </div>
        </div>
